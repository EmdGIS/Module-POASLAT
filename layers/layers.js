...
var format_limite_confirmee_Latmingue_21 = new ol.format.GeoJSON();
var features_limite_confirmee_Latmingue_21 = format_limite_confirmee_Latmingue_21.readFeatures(json_limite_confirmee_Latmingue_21, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_limite_confirmee_Latmingue_21 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_limite_confirmee_Latmingue_21.addFeatures(features_limite_confirmee_Latmingue_21);
var lyr_limite_confirmee_Latmingue_21 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_limite_confirmee_Latmingue_21, 
                style: style_limite_confirmee_Latmingue_21,
                popuplayertitle: "limite_confirmee_Latmingue",
                interactive: true,
                title: '<img src="styles/legend/limite_confirmee_Latmingue_21.png" /> limite_confirmee_Latmingue'
            });
var format_bornes_parcelles_latmingue_22 = new ol.format.GeoJSON();
var features_bornes_parcelles_latmingue_22 = format_bornes_parcelles_latmingue_22.readFeatures(json_bornes_parcelles_latmingue_22, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_bornes_parcelles_latmingue_22 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_bornes_parcelles_latmingue_22.addFeatures(features_bornes_parcelles_latmingue_22);
var lyr_bornes_parcelles_latmingue_22 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_bornes_parcelles_latmingue_22,
maxResolution:1.4002233076130983,
 
                style: style_bornes_parcelles_latmingue_22,
                popuplayertitle: "bornes_parcelles_latmingue",
                interactive: true,
                title: '<img src="styles/legend/bornes_parcelles_latmingue_22.png" /> bornes_parcelles_latmingue'
            });
var format_Parcelles_latmingue_23 = new ol.format.GeoJSON();
var features_Parcelles_latmingue_23 = format_Parcelles_latmingue_23.readFeatures(json_Parcelles_latmingue_23, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Parcelles_latmingue_23 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Parcelles_latmingue_23.addFeatures(features_Parcelles_latmingue_23);
var lyr_Parcelles_latmingue_23 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Parcelles_latmingue_23, 
                style: style_Parcelles_latmingue_23,
                popuplayertitle: "Parcelles_latmingue",
                interactive: true,
    title: 'Parcelles_latmingue<br />\
    <img src="styles/legend/Parcelles_latmingue_23_0.png" /> Aucun empiettement<br />\
    <img src="styles/legend/Parcelles_latmingue_23_1.png" /> Empiettement<br />'
        });
var group_Parcelles = new ol.layer.Group({
                                layers: [lyr_bornes_parcelles_latmingue_22,lyr_Parcelles_latmingue_23,],
                                fold: "open",
                                title: "Parcelles"});
var group_LATMINGUE = new ol.layer.Group({
                                layers: [lyr_INFRASTRUCTURES_19,lyr_Localit_20,lyr_limite_confirmee_Latmingue_21,],
                                fold: "open",
                                title: "LATMINGUE"});
